...
CREATE TABLE `detalle_factura` (
  ...
  CONSTRAINT `fk_detalle_factura_producto1` FOREIGN KEY (`Codigo_Producto`) REFERENCES `producto` (`Codigo_Producto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `producto` (
  ...
  `Combo_Adquirido` varchar(120) DEFAULT NULL,
  `Fecha_Creado` datetime DEFAULT NULL,
  `Fecha_Modificado` datetime DEFAULT NULL,
  `Fecha_Eliminado` datetime DEFAULT NULL,
  `Usuario_Creado` datetime DEFAULT NULL,
