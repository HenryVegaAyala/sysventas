...
//      $this->Image('ruta de imagen', horizontal, vertical, ancho, alto);
        ...
        $this->Cell(27.5, 1, utf8_decode('Lista de Clientes que Asistiran'), 0, 'C', 'C');
        $this->Ln(2);
        ...
        $this->Cell(9.16, 0.5, utf8_decode('Estado del Reporte: ' . 'Cita Concretada'), 0, '', 'L');
        ...
        FROM cliente
        WHERE Estado = 2 and Fecha_Creado BETWEEN '" . $fechaIni . "' and '" . $fechaFin . "'
        ";
