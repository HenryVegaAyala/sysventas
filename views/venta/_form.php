...
<div class="panel panel-default">
    ...
    <div class="container-fluid">
        ...
        $form = ActiveForm::begin(['action' => 'reporte', 'id' => 'forum_post', 'method' => 'post','options'=>['target'=>'_blank']]);
    ...
    <div class="fieldset">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <?= $form->field($model, 'Codigo_pasaporte')->widget(\yii\jui\AutoComplete::classname(), [
                        'options' => [
                            'class' => 'form-control',
                        ],
                        'clientOptions' => [
                            'source' => $model->getPasaporte(),
                        ],
                    ]) ?>
                </div>
                <div class="col-sm-3">
